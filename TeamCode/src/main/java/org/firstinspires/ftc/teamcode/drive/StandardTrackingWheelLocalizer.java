...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double LATERAL_DISTANCE = 9.84252; // in; distance between the left and right wheels
    public static double FORWARD_OFFSET = 3.93701; // in; offset of the lateral wheel
